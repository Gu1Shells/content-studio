  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        secret: true,
        help: "OBRIGATÓRIA para temas como GTA 6. Sem ela só cai no Pexels genérico. https://serper.dev",
        helpUrl: "https://serper.dev/",
      },
      {
        key: "WEB_IMAGES_FIRST",
        label: "Priorizar Google Images (true/false)",
        placeholder: "false",
        help: "true = sempre busca Serper antes do Pexels. Temas IP (GTA) já forçam Google automaticamente.",
      },
    ],
  },
  {
